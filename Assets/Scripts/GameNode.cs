...
public class GameNode: Node
{
    ...
    public GameNode(int nombre, string nom, bool estEndroitPublic, int étage, 
        List<int>connectedNodes,GPSCoordinate coordonéesGps ):base(nombre,nom,estEndroitPublic,étage,connectedNodes,coordonéesGps)
    {
