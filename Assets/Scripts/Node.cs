...
public class Node 
{
    ...
    {
        float posHorz = GPSCoordinate.CalculerDistanceXEntreDeuxCoordonnées
            (origine.CoordonéesGPS, CoordonéesGPS);
        float posVert = GPSCoordinate.CalculerDistanceYEntreDeuxCoordonnées
            (origine.CoordonéesGPS, CoordonéesGPS);
        Position = new Vector3(posHorz, 0, posVert);
    }
